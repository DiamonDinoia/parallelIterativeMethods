...
/** \internal
  ...
  *      | A10 A11 |
  *
  * This function reduces to bidiagonal form the left \c rows x \a block_size vertical panel [A00/A10]
  * and the \a block_size x \c cols horizontal panel [A00 A01] of the matrix \a A. The bottom-right block A11
